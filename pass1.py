...
import file
tokenize
process line ->AD,IS,REG,Literals,Symbols(vars,labels),Intermediate Code+LC
create data-structures intermediate_table,pool_table,symbol_table,literal_table?
"""
